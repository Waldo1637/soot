...
public class Scene //extends AbstractHost
{
     ...
     * version of it. Else pass it through.
     */
     ...
     *
     * @throws IllegalStateException if the RefType for this class cannot be
     * found. Use {@link #containsType(String)} to check if type is registered
     */
    ...
    public Hierarchy getActiveHierarchy() {
        if (!hasActiveHierarchy()) //throw new RuntimeException("no active Hierarchy present for scene");
        {
